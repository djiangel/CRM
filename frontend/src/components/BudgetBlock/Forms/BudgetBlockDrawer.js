...
import BudgetBlockUpdate from './BudgetBlockUpdate';
import BudgetBlockCreate from './BudgetBlockCreate';
import { PlusOutlined, EditOutlined, DeleteOutlined } from '@ant-design/icons';

export default function BudgetBlockDrawer({ button_name, title, component, data, button_type, button_style, ghost, inlineCreate, button_shape }) {
            ...
            >
                {
                    component === 'BudgetBlockUpdate' && visible ?
                        <BudgetBlockUpdate budget_block={data} onClose={() => setVisible(false)} />
                        :
                        component === 'BudgetBlockCreate' && visible ?
                            <BudgetBlockCreate budget_block={data} onClose={() => setVisible(false)} />
                            : null
                }
            </Drawer>
        </React.Fragment>
