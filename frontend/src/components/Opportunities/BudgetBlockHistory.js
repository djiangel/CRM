...
import { Modal, List, Avatar, Button, Popover, Timeline, Drawer, Tag } from 'antd';
import { FieldTimeOutlined, UserOutlined, MessageOutlined } from '@ant-design/icons';
import { useDispatch, useSelector } from 'react-redux'

export default function BudgetBlockHistory(props) {
    ...
    return (
        <React.Fragment>
            <Button size='small' shape='circle' type='text' onClick={() => setVisible(!visible)}>
