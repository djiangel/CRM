...
from river_admin_remake.views.error_code import CAN_NOT_DELETE_DUE_TO_PROTECTION, DUPLICATE_ITEM
...
def _path(path, method, **options):
    def decorator(view):
        authentications = options.get("authentication_classes", [JWTAuthentication])
