...
from river_admin_remake.views import post, delete
from river_admin_remake.views.serializers import CreateTransitionHookDto , TransitionHookDto
...
def create_it(request):
    ...
    if create_transition_hook_request.is_valid():
        ...
        return Response({"data": TransitionHookDto(transition_hook).data}, status=HTTP_200_OK)
    else:
